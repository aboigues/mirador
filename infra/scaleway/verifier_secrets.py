...
def _object_storage() -> str:
    if _requis("AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY"):
        return "⚠️  ignoré — AWS_ACCESS_KEY_ID / AWS_SECRET_ACCESS_KEY absents"
    import boto3
...
def _mnq() -> str:
    ...
    # peut pas se reposer sur les AWS_* de l'environnement.
    sqs = boto3.client(
        "sqs",
